...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  <div className="shadow-two hover:shadow-one dark:bg-gray-800 dark:shadow-three dark:hover:shadow-gray-dark rounded-xs bg-[#eaf4fb] p-8 duration-300 lg:px-5 xl:px-8">

      ...
      <div className="container">
        ...
        <div className="text-center">
          <div className="mb-6 flex items-center justify-center gap-2">
            ...
            <a href="https://wa.me/51932446031" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 font-semibold transition-colors duration-200">
              +51 932 446 031
            </a>
          </div>
          <Link

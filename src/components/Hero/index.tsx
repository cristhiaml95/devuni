// Suggested code may be subject to a license. Learn more: ~LicenseLog:3478984749.
...
const Hero = () => {
  return (
    <>
      <section
        id="home"
  className="relative z-10 overflow-hidden bg-[#eaf4fb] pb-16 pt-[140px] dark:bg-gray-800 md:pb-[120px] md:pt-[170px] xl:pb-[160px] xl:pt-[200px] 2xl:pb-[200px] 2xl:pt-[230px]"
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="#contact"
                    title="Solicita tu presupuesto personalizado gratuito"
